...
\cvline{}{\small My expertise lies at the intersection of computer programming and software design for state-of-the-art robotics. Working in this field has provided me with a broad, cross-functional perspective, incorporating mechanical design, electronics, firmware, and control systems into my software approach.\newline
I bring a robust background in GUI design, communication protocols, and embedded systems, complemented by proven experience in team management. While C++ is my primary language of choice, I am highly proficient in scripting for analysis and automation using Python, Matlab, and Lua.}
%Section
\section{Skills}
...
\section{Experience}
\subsection{Work}
\cventry{from 02/2023 to present}{Team Leader @ iCub Tech}{Istituto Italiano di Tecnologia}{Genova}{Italy}
{
I led a multidisciplinary team within the iCub Tech department, serving as both Technical Lead and Scrum Master. I facilitated all Agile ceremonies to streamline communication and reduce technical debt, directly improving sprint velocity. I partnered with Product Owners to refine and prioritize the backlog, ensuring tight alignment between customer expectations and technical execution. Cultivated a culture of responsibility that significantly boosted the team’s sense of ownership over the product.}
